    ...
    return (
        <>
            <DivSkills>
                ...
                <DivSkillTest>
                    <SpanSkillTest>
                        Meu maior objetivo pessoal após eu conseguir ter uma boa
                        experiência na carreira é encontrar alguma pessoa que
                        tenha a mesma garra e vontade que eu tive quando comecei
                        na área e assim guiá-la para o sucesso, sinto que passar
